...
<div class="content">
    ...
    <h2 class="intro-y text-lg font-medium mt-5">
        Daftar Data Staff Pendaftaran
    </h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <a href="javascript:;" onclick="createBtnOnclick()" data-toggle="modal" data-target="#createmodal" class="button inline-block bg-theme-1 text-white">Tambah Karywan SP Baru</a>
        ...
        <!-- BEGIN: Data List -->
        <script>
            var routeInitial = "datastaffpendaftaran";
        </script>
        <div id="tableBase" class="intro-y col-span-12 overflow-auto lg:overflow-visible">
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        <th class="whitespace-no-wrap">ID Staff Pendaftaran</th>
