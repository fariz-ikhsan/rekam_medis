...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            <a href="javascript:;" onclick="createBtnOnclick()" data-toggle="modal" data-target="#createmodal" class="button inline-block bg-theme-1 text-white">Tambah Dokter Baru</a>
